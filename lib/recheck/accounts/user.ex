defmodule Recheck.Accounts.User do
  use Ecto.Schema
  import Ecto.Changeset

  @roles [:atendente, :avaliador, :admin]
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Recheck.Repo)
  ...
  """
  def valid_password?(%Recheck.Accounts.User{hashed_password: hashed_password}, password)
